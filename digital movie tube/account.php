 ...
 <body style="background-image: url(images/6.jpeg);">
   <header>
      ...
      echo"  <form  action='update.php' method='POST'>
          ...
          <br>
          <input type='text' class='form-control' placeholder='Enter mobile number' name='phn'  style='background-color: black;color: red;font-size: 20px;margin-left:10px;margin-top:10px;padding:5px;' value='".$result['phone']."'>
          <br>
